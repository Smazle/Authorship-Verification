...
We tested our solution by splitting the training data into two sets a test used
for training and a set used for testing. For this test we split with 80\% being
training, and the rest being test. We computed the average of 100 tests to
account for randomness. The accuracy on the 2015 dataset resulted only in 0.48
accuracy.
