...
\begin{table}
    ...
    \begin{tabular}{llll|ll}
        ...
        % Test 10.
        500 4-grams & NONE & NONE & NONE & 0.55830, 3 & 0.70468, 8 \\
        % Test 11.
        300 4-grams & NONE & NONE & NONE & 0.52680, 3 & 0.71875, 6 \\
        % Test 12.
        150 4-grams & NONE & NONE & NONE & 0.53669, 6 & 0.64281, 7 \\
        % Test 13.
        500 3-grams & 300 1-grams & NONE & NONE & 0.5538, 2 & 0.69343, 6 \\
        % Test 14.
        300 3-grams & 300 1-grams & NONE & NONE & 0.53400, 2 & 0.71437, 6 \\
        % Test 15.
        1000 3-grams & NONE & NONE & NONE & 0.54910, 2 & 0.72156, 4 \\
        % Test 16.
        1000 4-grams & NONE & NONE & NONE & 0.57100, 2 & 0.72125, 3 \\
        % Test 17.
        1000 3-, 4-, 5-grams & NONE & NONE & NONE & 0.54579, 4 & 0.71968, 4 \\
        % Test 18.
        NONE & NONE & NONE & 20 1-, 2-, 3-grams & 0.61200, 2 & 0.59375, 8 \\
        % Test 19.
        NONE & NONE & NONE & 10 1-, 2-, 3-grams & 0.61370, 3 & 0.550625, 9 \\
        %% Test 20.
        %10 2-, 3-, 4-grams & NONE & NONE & 10 1-, 2-, 3-grams & 0.58980, 3 &
        %0.69406, 8
    \end{tabular}
...
% TODO: Add TPR and TNR using below data.
% For configuration A)
%     TP = 4.75
%     TN = 3.17
%     FP = 1.83
