...
%We found out that specific words, in this case stop words, has a great impact
%when validating the author. Not only that, but special characters also had a 
%far greater impact than anticipated.
%
%We can also conclude, that a problem like 
%
%
%
%
