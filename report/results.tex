...
frequencies of the 300 most frequent words and 100 most frequent 2-, 3- and
4-character-n-gram. The results on the two test datasets are shown in Table
\ref{table:svm_results}.
