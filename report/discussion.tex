...
%\begin{table}
    %\begin{tabular}{lll}
        %\textbf{Method} & \textbf{PAN 2013 Result} & \textbf{PAN 2015 Result} \\
        %\hline
        %\textbf{Delta Method}                      & 0.63864 & 0.31882 \\
        %\textbf{Generalising Random Forest Pancho} & n/a     & 0.3858 \\
        %\textbf{Generalising Random Forest Minus}  & n/a     & 0.3318 \\
        %\textbf{Extended Delta Method}             & 0.70193 & 0.40539 \\
        %\textbf{Author Specific SVM}               & 0.77858 & n/a
    %\end{tabular}
    %\caption{Final results for all our implemented algorithms for authorship
    %verification on the datasets that apply to the method.}
    %\label{tab:all_final_results}
